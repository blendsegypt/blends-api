...
const checkUsage = async (promoCode, userId) => {
    try {
...
const applyPromoCode = (promoCode, order) => {
    switch (promoCode.type) {
        case "free_delivery":
            ...
            break;
        case "percentage":
            order.sub_total -= (promoCode.percentage_discount / 100) * order.sub_total;
...
export { isPromoCodeExpired, isMinAmountReached, getPromoCode, checkUsage, applyPromoCode };