...
|--|--| --| -- |
| <b>User</b>
| /admin/users/ | POST | Object[User]  | Create a new user |
| /admin/users | PUT | Object[User]  | Update specific user |
| /admin/users | GET | {}  | Retrieve all users |
| /admin/users/:user_id | GET | {}  | Retrieve specific user |
| /admin/users | DELETE/:user_id | {}  | Delete specific user |
| <b>User Addresses</b>
| /admin/users/:user_id/addresses | POST | Object[Address]  | Add new address for a user |
| /admin/users/:user_id/addresses/:address_id | PUT | Object[Address]  | Update an address for a user |
| /admin/users/:user_id/addresses | GET | {}  | Retrieve all saved addresses of a user |
| /admin/users/:user_id/addresses/:user_id | GET | {}  | Retrieve a specific address of a user |
| /admin/users/:user_id/addresses/ | DELETE | {}  | Delete all addresses of a user |
| /admin/users/:user_id/addresses/:address_id | DELETE | {}  | Delete a specific address for a user |
| <b>Internal Categories</b>
| /admin/internal-categories/ | POST | Object[InternalCategory]  | Create a new category |
| /admin/internal-categories/:internal_category_id | PUT | Object[InternalCategory]  | Update a specific category 
| /admin/internal-categories | GET | {}  | Retrieve all internal categories |
| /admin/internal-categories/:internal_category_id | GET | {}  | Retrieve a specific category |
| /admin/internal-categories/:internal_category_id | DELETE | {}  | Delete a specific category |
|<b>Product Categories</b>
| /admin/product-categories | POST | Object[ProductCategory]  | Create a new category |
| /admin/product-categories/:product_category_id | PUT | Object[ProductCategory]  | Update a specific category |
| /admin/product-categories | GET | {}  | Retrieve all products categories |
| /admin/product-categories/:product_category_id | GET | {}  | Retrieve a specific category |
| /admin/product-categories/:product_category_id | DELETE | {}  | Delete a specific category |
|<b>Products (Admin)</b>
...
- **name** (string) (**mandatory**)
- **internal_category_id** (id) (**mandatory**)
### Product
- **order** (integer)
- **name** (string) (**mandatory**)
...
- **product_category_id** (id) (**mandatory**)
### ProductCustomOption
- **label** (string)
- **icon** (string)
- **mandatory** (boolean)
- **active** (boolean)
-- **product_id** (id)
- **custom_options** (array[CustomOption])
### CustomOption
- **label** (string)
- **price** (double)
- **value** (string)
